...
static void window_load(Window *window) {
    ...
    s_icon_bitmap = gbitmap_create_with_resource(RESOURCE_ID_CAR_BLACK);
    ...
    text_layer_set_text(s_label_layer, HOME_ON_TIME_WINDOW_MESSAGE);
