...
static void window_load(Window *window) {
    ...
    s_icon_bitmap = gbitmap_create_with_resource(RESOURCE_ID_HAMBURGER_BLACK);
    ...
    text_layer_set_text(s_label_layer, LUNCH_WINDOW_MESSAGE);
